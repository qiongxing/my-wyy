...
import { CurrentActions } from '../reducers/plaer.reducer';
...
export const setCurrentAction = createAction('[player] SetCurrentAction', props<{ currentAction: CurrentActions }>()); 